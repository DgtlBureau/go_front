...
$APPLICATION->SetTitle("Gohockey-Final");
?><div class="gohockey-final">
    <div class="gohockey-final__info">
        <div class="gohockey-final__about">
            <div class="gohockey-final__about-title">
                ...
                <p>Команда</p>
                <div class="gohockey-final__team-name"><span data-text="<?=$GLOBALS['SITE_SETTINGS']['go']['LOGO_TEXT']?>" id="GO"><?=$GLOBALS['SITE_SETTINGS']['go']['LOGO_TEXT']?></span></div>
            </div>
    ...
    <div class="gohockey-final__info-nav">
        ...
        <div class="gohockey-final__nav-item">Турниры</div>
        <div class="gohockey-final__nav-item">Новости</div>
    </div>
...
.gohockey-final__about {
    max-width: 610px;
    margin-right: 10%;
    padding-top: 40px
}

.gohockey-final__about-title {
    display: -webkit-box;
    display: -ms-flexbox;
    display: flex;
    font-style: normal;
...
.gohockey-final__about-title p:first-child {
    display: contents
}

.gohockey-final__about-title p:nth-child(2) {
    display: none
}
...
.gohockey-final__about-title span::after {
    content: attr(data-text);
    position: absolute;
...
.gohockey-final__progress-background {
...
.gohockey-final__progress-stats {
    display: -webkit-box;
    display: -ms-flexbox;
    display: flex;
...
.gohockey-final__progress-title {
    font-style: normal;
    font-weight: 400;
    font-size: 20px;
    line-height: 25px;
...
.gohockey-final__progress-victories {
    display: -webkit-box;
    display: -ms-flexbox;
    display: flex;
...
.gohockey-final__progress-victories span {
    position: relative;
    color: #000;
...
.gohockey-final__progress-victories span::before {
    content: attr(data-text);
    position: absolute;
...
.gohockey-final__progress-victories span::after {
    content: attr(data-text);
    position: absolute;
...
.gohockey-final__progress-points {
    display: -webkit-box;
    display: -ms-flexbox;
    display: flex;
    -webkit-box-orient: vertical;
...
.gohockey-final__progress-points span {
    position: relative;
    color: #000;
    -webkit-text-stroke: .16em #000;
    -webkit-text-stroke-width: 24px;
...
.gohockey-final__progress-points span::before {
    content: attr(data-text);
    position: absolute;
    -webkit-text-stroke: .02em #000;
    -webkit-text-stroke-width: 2px;
...
.gohockey-final__progress-points span::after {
    content: attr(data-text);
    position: absolute;
    -webkit-text-stroke: .02em #fff;
    -webkit-text-stroke-width: 10px;
...
.gohockey-final__progress-place {
    display: -webkit-box;
    display: -ms-flexbox;
    display: flex;
    -webkit-box-orient: vertical;
...
.gohockey-final__progress-place span {
    position: relative;
    color: #000;
    -webkit-text-stroke: .16em #000;
    -webkit-text-stroke-width: 24px;
...
.gohockey-final__progress-place span::before {
    content: attr(data-text);
    position: absolute;
    -webkit-text-stroke: .02em #000;
    -webkit-text-stroke-width: 2px;
...
.gohockey-final__progress-place span::after {
    content: attr(data-text);
    position: absolute;
    -webkit-text-stroke: .02em #fff;
    -webkit-text-stroke-width: 10px;
...
.gohockey-final__nav-item:nth-child(2) {
...
.gohockey-final__nav-item p:nth-child(2) {
    display: none
}

.gohockey-final__nav-item:last-child {
    border-right: none
}

.gohockey-final__line-up {
    padding: 80px 40px;
    max-width: 1360px;
    margin: 0 auto
}

.gohockey-final__block {
    width: 100%;
    margin-top: 80px
}

.gohockey-final__title {
    padding-top: 10px
}

.gohockey-final__title-block {
    max-width: 1360px;
    font-size: 42px;
    line-height: 52px;
    letter-spacing: .02em;
...
.gohockey-final-bracket {
    max-width: 1360px;
    background: #141414;
    padding-top: 40px
}

.gohockey-final-bracket img {
    max-width: none
}

.gohockey-final-bracket__stage {
    padding: 0 70px;
    display: -webkit-box;
    display: -ms-flexbox;
    display: flex;
...
.gohockey-final-bracket .active-stage {
    color: #fff
}

.gohockey-final-bracket__separator-block {
    width: 18%;
    display: -webkit-box;
    display: -ms-flexbox;
    display: flex;
...
.gohockey-final-bracket__separator {
    border: 1px solid rgba(255, 255, 255, .1);
    width: 100%
}

.gohockey-final-bracket__results-block {
    height: 760px;
    display: -webkit-box;
    display: -ms-flexbox;
    display: flex
...
.gohockey-final-bracket__results {
    width: 100%;
    display: -webkit-box;
    display: -ms-flexbox;
    display: flex;
...
.gohockey-final-bracket__content {
    display: -webkit-box;
    display: -ms-flexbox;
    display: flex;
    max-height: 360px
...
.gohockey-final-bracket__quarter-result {
    display: -webkit-box;
    display: -ms-flexbox;
    display: flex;
    -webkit-box-align: center;
...
.gohockey-final-bracket__game {
    height: 162px;
    background: #000
}

.gohockey-final-bracket__game:nth-child(2n) {
    margin-top: 40px
}

.gohockey-final-bracket__team {
    width: 100%;
    display: -webkit-box;
    display: -ms-flexbox;
    display: flex;
...
.gohockey-final-bracket__team:nth-child(2n) {
    border-bottom: none
}

.gohockey-final-bracket__team-info {
    display: -webkit-box;
    display: -ms-flexbox;
    display: flex;
    -webkit-box-pack: center;
...
.gohockey-final-bracket__team-logo {
    min-width: 50px;
    width: 50px;
    height: 50px;
    margin: 8px
...
.gohockey-final-bracket__team-logo img {
    width: 100%
}

.gohockey-final-bracket__score {
    width: 60px;
    height: 80px;
    display: -webkit-box;
    display: -ms-flexbox;
...
.gohockey-final-bracket__score_winner {
    background: #ff4c01 !important
}

.gohockey-final-bracket__score_winner .gohockey-final-bracket__score-txt {
    color: #010101 !important
}

.gohockey-final-bracket .borders {
    border-left: 1px solid #141414;
    border-right: 1px solid #141414
}

.gohockey-final-bracket__score-txt {
    font-style: normal;
    font-weight: 400;
    font-size: 16px;
    line-height: 22px;
...
.gohockey-final-bracket__connecting-block {
    width: -webkit-fit-content;
    width: -moz-fit-content;
    width: fit-content;
    height: auto;
...
.gohockey-final-bracket__final-game-block {
    display: -webkit-box;
    display: -ms-flexbox;
    display: flex;
    height: 500px;
...
.gohockey-final-bracket__cup-block {
    display: -webkit-box;
    display: -ms-flexbox;
    display: flex;
    -ms-flex-wrap: wrap;
...
.gohockey-final-bracket__cup-image {
    width: 110px;
    margin-bottom: 10px;
    height: 110px
}

.gohockey-final-bracket__cup-image img {
    width: 100%
}

.gohockey-final-bracket__cup-name {
    text-align: center;
    font-style: normal;
    font-weight: 400;
    font-size: 28px;
...
.gohockey-final-bracket__final-teams-block {
    width: 205px;
    display: -webkit-box;
    display: -ms-flexbox;
    display: flex
...
.gohockey-final-bracket__final-teams {
    display: -webkit-box;
    display: -ms-flexbox;
    display: flex;
    -ms-flex-wrap: wrap;
...
.gohockey-final-bracket__final-game-player {
    background: rgba(0, 0, 0, .8)
}

.gohockey-final-bracket__final-game-player:last-child {
    border-left: 1px #141414 solid
}

.gohockey-final-bracket__logo-block {
    display: -webkit-box;
    display: -ms-flexbox;
    display: flex;
    -webkit-box-pack: center;
...
.gohockey-final-bracket__logo-block img {
    width: 100%
}

.gohockey-final-bracket__logo {
    width: 90px;
    height: 90px
}

.gohockey-final-bracket__final-score-block {
    display: -webkit-box;
    display: -ms-flexbox;
    display: flex;
    -webkit-box-pack: center;
...
.gohockey-final-bracket__final-score-block .gohockey-final-bracket__score-txt {
    font-weight: 800;
    font-size: 20px;
    line-height: 28px
}

.gohockey-final-bracket__final-score {
    font-weight: 400;
    font-size: 20px;
    line-height: 28px;
    text-align: center;
...
.gohockey-final-bracket__final-teams-title {
    font-size: 20px;
    line-height: 28px;
    font-weight: 600px;
    text-align: center;
...
.gohockey-final-bracket__mobile-result {
    display: none
}

.gohockey-final-bracket__result-mobile {
    display: none
}
...
.gohockey-final__swiper-block {
    max-width: 1360px
}

.gohockey-final__swiper {
    width: 100%
}

.gohockey-final__swiper div img {
    width: 100%;
    height: 100%
}

.gohockey-final__swiper .slick-prev,
.gohockey-final__swiper .slick-next {
    z-index: 1 !important;
...
.gohockey-final__swiper .slick-prev:before,
.gohockey-final__swiper .slick-next:before {
...
.gohockey-final__swiper .slick-list {
...
@media(max-width: 1140px) {
    ...
    .gohockey-final-bracket__stage-mobile {
        display: -webkit-box;
        display: -ms-flexbox;
        display: flex;
        -ms-flex-wrap: nowrap;
    ...
    .gohockey-final-bracket__current-stage {
        font-size: 16px;
        line-height: 22px;
        letter-spacing: .02em;
        text-transform: uppercase;
    ...
    .gohockey-final-bracket__quarter-result-block {
        display: -webkit-box;
        display: -ms-flexbox;
        display: flex;
        -webkit-box-align: center;
    ...
    .gohockey-final-bracket__dividing-line {
        position: relative;
        height: 440px;
        display: -webkit-box;
        display: -ms-flexbox;
    ...
    .gohockey-final-bracket__dividing-line-short {
        height: 230px
    }
...
@media(max-width: 800px) {
    ...
    .gohockey-final__nav-item p:nth-child(1) {
        display: none
    }
...
@media(max-width: 500px) {
    ...
    .gohockey-final__progress-stats span,
    .gohockey-final__progress-stats span::before,
    .gohockey-final__progress-stats span::after {
        font-size: 24px;
        line-height: 32px
    }
