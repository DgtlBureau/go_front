                ...
                <div class="go-news__about">
                    <div class="go-news__about-title">
                        ...
                        <div class="go-team__team-name"><span
                                    data-text="<?= $GLOBALS['SITE_SETTINGS']['go']['LOGO_TEXT'] ?>"
                                    id="GO"><?= $GLOBALS['SITE_SETTINGS']['go']['LOGO_TEXT'] ?></span></div>
                    </div>
    ...
    <div class="back-go-news__info-nav">
        <div class="container">
            <div class="go-news__info-nav">
                <a href="/teams/team-go/" class="go-news__nav-item">
                    <p>Состав команды</p>
                    <p>Состав</p>
                </a>
                <a href="/teams/team-go/tournament/" class="go-news__nav-item">Турниры</a>
                <div class="go-news__nav-item" href="/teams/team-go/news/">Новости</div>
            </div>
        </div>
    </div>
    ...
    <div class="go-news__content">
        ...
        <div class="social-content-block">
            ...
            <div class="social-content-block__content">
                <? $arrFilter = array("PROPERTY_TEAM" => 6, "SECTION_ID" => 22); ?>
                <? $APPLICATION->IncludeComponent(
                    "bitrix:news.list",
                    "social_posts_slider",
                    array(
        ...
        <div class="social-content-block">
            ...
            <div class="social-content-block__content">
                <? $arrFilter = array("PROPERTY_TEAM" => 6, "SECTION_ID" => 21); ?>
                <? $APPLICATION->IncludeComponent(
                    "bitrix:news.list",
                    "social_posts_slider",
                    array(
