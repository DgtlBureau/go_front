            ...
            <div class="championship-course__top">
                ...
                <div class="championship-course__select-block">
                    <select class="championship-course__period"
                        ...
                        <option VALUE="/teams/team-gohockey/tournament/">Регулярный чемпионат</option>
                        <option VALUE="/teams/team-gohockey/tournament/playoff/">Плей-офф</option>
                    </select>
                </div>
            </div>
            ...
            <div class="go-tournament__swiper-block">
                <div class="go-tournament__swiper">
                    ...
                    while ($best_player = $best_players->GetNext()) {
                        $best_player['DETAIL_PAGE_URL'] = '/teams/team-gohockey/players/?ELEMENT_ID=' . $best_player['ID'];
                        ?>
                        <a class="go-tournament__staff-person" href="<?= $best_player['DETAIL_PAGE_URL'] ?>">
                            <div class="<?= ($PROPERTY_TEAM == 6) ? 'go-tournament__players-staff-person-background_blue' : 'go-tournament__players-staff-person-background_orang'?>">
