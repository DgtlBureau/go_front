            ...
            <div class="go-team__info">
                <div class="go-team__about">
                    <div class="go-team__about-title">
                        ...
                        <p>Команда</p>
                        <div class="go-team__team-name"><span
                                    data-text="<?= $GLOBALS['SITE_SETTINGS']['gohockey']['LOGO_TEXT'] ?>"
                                    id="GO"><?= $GLOBALS['SITE_SETTINGS']['gohockey']['LOGO_TEXT'] ?></span></div>
                    </div>
                        ...
                        <div class="next-match__block" id="next-match__block">
                            ...
                            <div class="next-match__versus">
                                <div class="next-match__first-team">
                                    <div class="next-match__first-team-name"
                                         id="GO-first"><?= $mach_header_values["TITLE_TEAM_1"]["VALUE"] ?></div>
                                    <div class="next-match__first-team-logo">
                                        <img src="<?= CFile::GetPath($mach_header_values["LOGO_1"]["VALUE"]); ?>"
                                             alt="<?= $mach_header_values["TITLE_TEAM_1"]["VALUE"] ?>"></div>
                                    <div class="next-match__first-team-name"
                                         id="GO-second"><?= $mach_header_values["TITLE_TEAM_1"]["VALUE"] ?></div>
                                </div>
                                ...
                                <div class="next-match__second-team">
                                    <div class="next-match__second-team-logo">
                                        <img src="<?= CFile::GetPath($mach_header_values["LOGO_2"]["VALUE"]); ?>"
                                             alt="<?= $mach_header_values["TITLE_TEAM_2"]["VALUE"] ?>"></div>
