...
$APPLICATION->SetTitle("Gohockey-Quarter-Final");
    ...
    <div class="gohockey-quarter-final__info">
        <div class="gohockey-quarter-final__about">
            <div class="gohockey-quarter-final__about-title">
                ...
                <p>Команда</p>
                <div class="gohockey-quarter-final__team-name"><span data-text="<?=$GLOBALS['SITE_SETTINGS']['gohockey']['LOGO_TEXT']?>"
                        id="Gohockey"><?=$GLOBALS['SITE_SETTINGS']['gohockey']['LOGO_TEXT']?></span></div>
            </div>
...
.gohockey-quarter-final__info {
    background: -webkit-gradient(linear, left top, left bottom, from(#000000), color-stop(150.84%, rgba(8, 9, 49, 0))), url(/local/templates/new_ru/img/back.png) repeat-x;
...
.gohockeyrizontal-connecting img {
    width: 40px
}
...
<script>
  if ($(window).width() >= 1300) {
    $('.gohockey-quarter-final__swiper').slick({
      infinite: false,
      slidesToShow: 4,
      slidesToScroll: 1,
    });
