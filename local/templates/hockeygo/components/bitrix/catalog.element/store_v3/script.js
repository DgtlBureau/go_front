	...
	window.JCCatalogElement.prototype = {
		...
		initProductData: function()
		{
			...
			if (this.params.PRODUCT && typeof this.params.PRODUCT === 'object')
			{
				...
				this.product.size = this.params.PRODUCT.SIZE;
		...
		basketResult: function(arResult)
		{
			...
			else
			{
				...
				if (arResult.STATUS === 'OK')
				{
					...
					var sizeClass = document.querySelectorAll('.product-detail-scu-item-text-container.selected');
					var size = sizeClass[0].getAttribute('title');
					console.log(sizeClass);
					//console.log(this.product.article);

					popupContent = '<div class="popup_catalog" style="width: 100%; margin: 0;">'
						+ '<img src="' + productPict + '" height="130" style="max-height:130px"><div class="info_block"><div class="popup_title">'
						+ this.product.name + '</div><div class="art">Артикул: '+ this.product.article +'</div><div class="popup_title">Размер: '+ size +'</div></div></div>';
