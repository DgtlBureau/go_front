    ...
    <div class="shop__catalog catalog">
        ...
        <div class="catalog__products products">
            ...
            <ul class="catalog__filters-mobail-nav-list">
                <li class="catalog__filters-mobail-item" data-sort="property_PRODUCT">
                    Товары
                    <div class="catalog__filters-mobail-item-close">x</div>
                </li>
                <li class="catalog__filters-mobail-item"  data-sort="property_SECTION">
                    Раздел
                    <div class="catalog__filters-mobail-item-close">x</div>
                </li>
                <li class="catalog__filters-mobail-item"  data-sort="catalog_PRICE_1">
                    Цена
                    <div class="catalog__filters-mobail-item-close">x</div>
                </li>

                <li class="catalog__filters-mobail-item"  data-sort="property_HIT">
                    Предложения
                    <div class="catalog__filters-mobail-item-close">x</div>
                </li>
                <li class="catalog__filters-mobail-item"  data-sort="property_COLLECTION">
                    Коллекции
                    <div class="catalog__filters-mobail-item-close">x</div>
                </li>
                <li class="catalog__filters-mobail-item"  data-sort="property_TEAM">
                    Джерси
                    <div class="catalog__filters-mobail-item-close">x</div>
                </li>
            </ul>
            ...
            <div class="products__list">
                ...
                $intSectionID = $APPLICATION->IncludeComponent(
                    ...
                    array(
                        "IBLOCK_TYPE" => $arParams["IBLOCK_TYPE"],
                        "IBLOCK_ID" => $arParams["IBLOCK_ID"],
                        "ELEMENT_SORT_FIELD" => !empty($_GET['SORT_1']) ? $_GET['SORT_1'] :$arParams["ELEMENT_SORT_FIELD"], // catalog_PRICE_1
                        "ELEMENT_SORT_ORDER" => $arParams["ELEMENT_SORT_ORDER"],
                        "ELEMENT_SORT_FIELD2" => !empty($_GET['SORT_2']) ? $_GET['SORT_2'] :$arParams["ELEMENT_SORT_FIELD2"], // catalog_PRICE_1
