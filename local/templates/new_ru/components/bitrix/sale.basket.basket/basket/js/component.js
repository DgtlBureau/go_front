;(function () {
        ...
        BX.Sale.BasketComponent = {
            ...
            bindDeleteEvents: function () {
                ...
                $('.basket-item-actions-remove').on('click', function () {
                    $('.product-delete__modal').removeClass('hide');
                    $('bode').addClass('no-overflow');

                    var productId = $(this).data('id')
                    console.log(productId);

                    // скрываем на крестик или отмена
                    $('.delete-cancel').on('click', function () {
                        $('.product-delete__modal').addClass('hide');
                        $('body').removeClass('no-overflow');
                    });
                    $('.product-delete__close-btn').on('click', function () {
                        $('.product-delete__modal').addClass('hide');
                        $('body').removeClass('no-overflow');
                    });
