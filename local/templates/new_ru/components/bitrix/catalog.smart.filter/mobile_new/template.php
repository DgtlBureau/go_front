...
<div class="catalog__modal modal hide" id="filters-modal">
    <div class="modal__content bx-filter">
        ...
        <form name="<? echo $arResult["FILTER_NAME"] . "_form" ?>" action="<? echo $arResult["FORM_ACTION"] ?>"
              method="get"
              class="catalog__filters-form filters-form_mobile">
            ...
            <div class="catalog__filters_products">
                ...
                foreach ($arResult["ITEMS"] as $key => $arItem) {
                    if ($arItem['CODE'] == 'OLD_PRICE' || $count > 2 || empty($arItem["VALUES"]) || isset($arItem["PRICE"]))
                        continue;
                    if ($arItem["DISPLAY_TYPE"] == "A" && ($arItem["VALUES"]["MAX"]["VALUE"] - $arItem["VALUES"]["MIN"]["VALUE"] <= 0))
                        continue; ?>
                    <div class="catalog__filters_products-category">
                        <div class="catalog__filters_subtitle"><?= $arItem["NAME"] ?></div>
                        <?
                        ...
                        case "A"://NUMBERS_WITH_SLIDER
                            ...
                            <div class="col-xs-12 col-xs-offset-1 bx-ui-slider-track-container">
...
//                dump($prices);
                ...
                //not prices
                foreach ($arResult["ITEMS"] as $key => $arItem) {
                    if ($arItem['CODE'] == 'OLD_PRICE' || empty($arItem["VALUES"]) || isset($arItem["PRICE"]))
                        continue;
...
<!--                </div>-->
                ...
                <div class="bx-filter-button-box">
                    <div class="bx-filter-block">
                        <div class="bx-filter-parameters-box-container">
                            <input
                                    class="modal__btn modal__btn-txt"
                                    type="submit"
                                    id="set_filter"
                                    name="set_filter"
                                    value="<?= GetMessage("CT_BCSF_SET_FILTER") ?>"
                            />
<!--                            <input-->
<!--                                    class="modal__btn modal-reset-btn modal__btn-txt"-->
<!--                                    type="submit"-->
<!--                                    id="del_filter"-->
<!--                                    name="del_filter"-->
<!--                                    value="--><?//= GetMessage("CT_BCSF_DEL_FILTER") ?><!--"-->
<!--                            />-->
                            <div class="modal__btn modal-reset-btn" id="modal-reset-btn-filters">
                                <a href="/shop/catalog/odezhda/" class="modal__btn-txt">Сбросить</a>
                            </div>
                            <div class="bx-filter-popup-result <? if ($arParams["FILTER_VIEW_MODE"] == "VERTICAL") echo $arParams["POPUP_POSITION"] ?>"
                                 id="modef" <? if (!isset($arResult["ELEMENT_COUNT"])) echo 'style="display:none"'; ?>
