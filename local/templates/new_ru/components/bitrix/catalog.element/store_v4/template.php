...
?>
    <div class="product-added__modal hide" id="product-added__modal">
        <div class="product-added__content">
            ...
            <div class="product-added__btn-block">
                <div class="product-added__btn">
                    <div class="product-added__btn-txt"><?= Loc::getMessage('CT_BCE_CATALOG_BTN_MESSAGE_CLOSE_POPUP') ?></div>
                </div>
                <a class="product-added__btn" href="<?= $arResult['ORIGINAL_PARAMETERS']['BASKET_URL'] ?>">
                    <div class="product-added__btn-txt"><?= Loc::getMessage('CT_BCE_CATALOG_BTN_MESSAGE_BASKET_REDIRECT') ?></div>
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="shop__card-products card-products" id="<?= $itemIds['ID'] ?>" itemscope
        ...
        <div class="card-products__info">
            <div class="card-products__title-block" id="<?= $itemIds['BASKET_PROP_DIV'] ?>">
                <div class="card-products__title"><?= $name ?></div>
                <? if (!empty($arResult['PROPERTIES']['ARTICLE']['VALUE'])): ?>
                    <div class="card-products__vendor-code">
                        Артикул: <span><?= $arResult['PROPERTIES']['ARTICLE']['VALUE'] ?></span>
                    </div>
                <? endif; ?>
...
//                    echo '</pre>';
                    ...
                    <div class="card-products__size-selection-title"><span class="padding">Добавить печать</span>
                        <div class="card-products__payment-choose">
                            <select>
                                        ...
                                        if ($showAddBtn) {
                                            ...
                                            <div class="card-products__buy-block"
                                                ...
                                                <div class="card-products__basket">
                                                    <img src="<?= SITE_TEMPLATE_PATH . '/assets/go_shop_build/ShopCard/assets' ?>/basket_black.svg"
                                                         alt="basket_black">
                                                </div>
                                                <div class="card-products__buy"><?= $arParams['MESS_BTN_ADD_TO_BASKET'] ?></div>
                                            </div>
                                            <?php
                                        }
                ...
                <div class="card-products__description-block">
                    ...
                    if (!empty($arResult['PROPERTIES']['STRUCTURE']['VALUE'])): ?>
                        ...
                        <div class="card-products__compound">
                            ...
                            <div class="card-products__compound-text"><?= $arResult['PROPERTIES']['STRUCTURE']['VALUE'] ?></div>
                        </div>
                    <?
                    endif;
                    ?>
                    <div class="card-products__delivery">
                        <div class="card-products__delivery-icon">
                            <img src="<?= SITE_TEMPLATE_PATH . '/assets/go_shop_build/ShopCard/assets' ?>/delivery.svg"
                                 alt="delivery">
                        </div>
