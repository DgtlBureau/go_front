...
//    echo '</pre>';
    ...
    <main class="shop">
        <div class="container"><a class="go-back-bnt" href="<?= $arParams['PATH_TO_BASKET'] ?>">
            ...
            <div class="order" id="bx-soa-order">
                ...
                <div id="bx-soa-paysystem" class="order__payment bx-soa-section bx-active">

                    <!--                    <div data-visited="false" class="bx-soa-section bx-active">-->
                    <!--                        <div class="bx-soa-section-content container-fluid"></div>-->
                    <!--                    </div>-->

                    <!--	PAY SYSTEMS BLOCK	-->
                    <div class="order__payment-title"><?= $arParams['MESS_PAYMENT_BLOCK_NAME'] ?></div>
                    <div id="payment-systems" class="order__payment-choose">
                        <select>
    ...
    <script>
        ...
        BX.Sale.OrderAjaxComponent.init({
            ...
            profilePropsBlockId: 'profile-properties',
            otherPropsBlockId: 'others-properties',
        });
    </script>
    <script>
        <?
