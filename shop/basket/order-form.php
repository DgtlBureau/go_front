                ...
                <div class="order__inputs address_data">
                    <div class="address_data_form">
                        <div class="order__inputs-item input">
                            ...
                            <div class="error-txt hide" id="counry-error">Введите имя</div>
                        </div>
                        <div class="order__inputs-item input">
                            <input class="order__input required_address" placeholder="Город*">
                            <div class="error-txt hide" id="city-error">Введите телефон</div>
                        </div>
                        <div class="order__inputs-item input">
                            <input class="order__input required_address" placeholder="Индекс*">
                            <div class="error-txt hide" id="index-error">Введите фамилию</div>
                        </div>
                        <div class="order__inputs-item input">
                            <input class="order__input required_address" placeholder="Улица*">
                            <div class="error-txt hide" id="street-error">Введите email</div>
                        </div>
                        <div class="order__inputs-item input">
                            <input class="order__input required_address" placeholder="Дом/корпус*">
                            <div class="error-txt hide" id="house-error">Введите фамилию</div>
                        </div>
                        <div class="order__inputs-item input">
                            <input class="order__input required_address" placeholder="Квартира/офис*">
                            <div class="error-txt hide" id="flat-error">Введите email</div>
                        </div>
                        <div class="order__inputs-item order__inputs-comment textarea">
                            <textarea class="order__input order__input-comment" type="text"
                                placeholder="Комментарий к заказу">
                            </textarea>
                        </div>
                    </div>
                    <div class="sdek_map hide"></div>
                </div>
            </form>
            <div class="order__payment">
                <div class="order__payment-title">Способы оплаты</div>
                ...
                <div class="order__payment-price">
                    <div class="order__payment-txt">Сумма заказа</div>
                    <div class="order__payment-txt">24 560 ₽</div>
                </div>
                <div class="order__payment-price">
                    <div class="order__payment-txt">Количество товаров</div>
                    <div class="order__payment-txt">23</div>
                </div>
                <div class="order__payment-price paymant-summ">
                    <div class="order__payment-txt">Итого</div>
                    <div class="order__payment-txt">24 060 ₽</div>
                </div>
                <a class="order__payment-btn" href="#">
                    <div class="order__payment-btn-txt">Перейти к оплате</div>
                </a>
                <div class="data-processing-block">
                    <input class="data-processing" type="checkbox" id="data-processing">
                    <div class="data-processing-txt">Я даю согласие на обработку персональных данных</div>
                </div>
            </div>
        </div>
    </div>
