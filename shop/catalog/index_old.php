...
?><div id="bx_basketFKauiI">
	 <!--'start_frame_cache_bx_basketFKauiI'--> <a href="/basket/" class="catalog-cart-block"> <span class="catalog-cart-counter">2</span> </a>
...
<div class="desctop">
	...
	Array(
		...
		"DETAIL_OFFERS_PROPERTY_CODE" => array(0=>"SIZE",1=>"",),
		"DETAIL_PRODUCT_INFO_BLOCK_ORDER" => "sku,props",
		"DETAIL_PRODUCT_PAY_BLOCK_ORDER" => "quantity,rating,price,priceRanges,quantityLimit,buttons",
		"DETAIL_PROPERTY_CODE" => array(0=>"ARTICLE",1=>"COLLECTION",2=>"HIT",3=>"SECTION",4=>"STRUCTURE",5=>"OLD_PRICE",6=>"PRODUCT",7=>"",),
		...
		"FILTER_OFFERS_PROPERTY_CODE" => array("SIZE",""),
		"FILTER_PRICE_CODE" => array("BASE"),
		"FILTER_PROPERTY_CODE" => array("COLLECTION","HIT","SECTION","OLD_PRICE","PRODUCT",""),
		...
		"LIST_PROPERTY_CODE" => array(0=>"COLLECTION",1=>"HIT",2=>"SECTION",3=>"OLD_PRICE",4=>"PRODUCT",5=>"",),
...
// 	var myButtonClasses = document.getElementByClass("desctop").classList;
// 	var myButtonClasses1 = document.getElementByClass("search_desc").classList;
// 	myButtonClasses.remove("desctop");
// 	myButtonClasses.remove("desctop");
// }
// 	 }

	//  let desctop = document.querySelector('.desctop');
	//  let search = document.querySelector('.search_desc');
	// 	if(document.documentElement.clientWidth < 500){
	// 		desctop.classList.remove('desctop');
	// 		search.classList.remove('search_desc');
	// 	}

	// let mobile = document.querySelector('.mobile_catalog');
	// if(document.documentElement.clientWidth > 500){
	// 	mobile.classList.remove('mobile_catalog');
	// }
</script>
<div class="mobile_catalog">
	...
	array(
		...
		"LIST_PRODUCT_BLOCKS_ORDER" => "price,props,sku,quantityLimit,quantity,buttons",
		"LIST_PRODUCT_ROW_VARIANTS" => "[{'VARIANT':'1','BIG_DATA':false},{'VARIANT':'1','BIG_DATA':false},{'VARIANT':'1','BIG_DATA':false},{'VARIANT':'1','BIG_DATA':false},{'VARIANT':'1','BIG_DATA':false}]",
