    ...
    <main class="shop">
        ...
        <div class="flex_container">
            <div class="shop__new-product">
                ...
                <?
                $GLOBALS['arrFilter'] = ['SECTION_CODE' => ['novinki']];
                ?>
        ...
        foreach ($arrForFilter as $arCategoryCode):
            ?>
            <div class="flex_container">
                <div class="shop__categories categories">
                    ...
                    <?
                    $GLOBALS['arrFilter'] = ['CODE' => $arCategoryCode];
                    ?>
                    <? $APPLICATION->IncludeComponent(
            ...
            <div class="flex_container">
                <div class="swipe_content">
                    <?
                    $GLOBALS['arrFilter'] = ['SECTION_CODE' => $arCategoryCode];
                    ?>
                    <div class="shop__swiper-block">
                        <div class="shop__swiper">
                            <? $APPLICATION->IncludeComponent(
